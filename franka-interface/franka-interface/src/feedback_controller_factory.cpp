...
FeedbackController* FeedbackControllerFactory::getFeedbackControllerForSkill(SharedBufferTypePtr buffer, SensorDataManager* sensor_data_manager){
  ...
  switch (feedback_controller_type) {
    ...
    case FeedbackControllerType::SetInternalImpedanceFeedbackController:
      ...
      break;
    case FeedbackControllerType::ModifiedForcePositionFeedbackController:
      feedback_controller_type_name = "ModifiedForcePositionFeedbackController";
      feedback_controller = new ModifiedForcePositionFeedbackController(buffer, sensor_data_manager);
      break;
    default:
