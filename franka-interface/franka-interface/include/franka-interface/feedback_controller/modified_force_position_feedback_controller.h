#ifndef FRANKA_INTERFACE_FEEDBACK_CONTROLLER_MODIFIED_FORCE_POSITION_FEEDBACK_CONTROLLER_H_
#define FRANKA_INTERFACE_FEEDBACK_CONTROLLER_MODIFIED_FORCE_POSITION_FEEDBACK_CONTROLLER_H_
...
class ModifiedForcePositionFeedbackController : public FeedbackController {
 public:
 ...
 private:
  ...
  Eigen::Matrix<double, 7, 1> tau_x_, tau_f_, tau_task_, tau_d_, q_es_, tau_es_, tau_nullspace;
};

#endif  // FRANKA_INTERFACE_FEEDBACK_CONTROLLER_MODIFIED_FORCE_POSITION_FEEDBACK_CONTROLLER_H_
