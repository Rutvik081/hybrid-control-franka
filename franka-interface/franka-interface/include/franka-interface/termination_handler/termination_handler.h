...
class TerminationHandler {
 ...
 protected:
  ...
  const std::vector<Eigen::Hyperplane<double,3>> planes_ {
    // Front (original x: 0.75)
    Eigen::Hyperplane<double, 3>(Eigen::Vector3d(1., 0., 0.), Eigen::Vector3d(1.5, 0., 0.)),
    // Sides 
    Eigen::Hyperplane<double, 3>(Eigen::Vector3d(0., 1., 0.), Eigen::Vector3d(0., 1.2, 0.)),
    Eigen::Hyperplane<double, 3>(Eigen::Vector3d(0., 1., 0.), Eigen::Vector3d(0., -1.2, 0.)),
    // Bottom
