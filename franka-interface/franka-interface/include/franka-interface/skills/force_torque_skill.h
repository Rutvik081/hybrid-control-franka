#ifndef FRANKA_INTERFACE_SKILLS_FORCE_TORQUE_SKILL_H_
#define FRANKA_INTERFACE_SKILLS_FORCE_TORQUE_SKILL_H_
...
class ForceTorqueSkill : public BaseSkill {
 ...
 private:
  ...
  std::array<double, 7> max_joint_torques_{87, 87, 87, 87, 50, 50, 50}; // Nm
  std::array<double, 7> max_joint_rotatums_{1000, 1000, 1000, 1000, 1000, 1000, 1000}; // Nm / s
};

#endif  // FRANKA_INTERFACE_SKILLS_FORCE_TORQUE_SKILL_H_
